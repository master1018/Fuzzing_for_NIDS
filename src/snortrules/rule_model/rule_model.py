...
class RuleNode(object):
    """
    A rule node can be one rule or a certain part of a rule denoting
    the protocol mentioned in the rule.
    """
...
class RuleModel(object):
    """
    Modeling a single rule of Snort3. The model includes the protocol
    information and attack information.
    """
